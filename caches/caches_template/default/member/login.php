...
<title>My-Admin - <?php echo L('member','','member').L('manage_center');?></title>
...
<div id="header">
	<div class="content">
	<div class="logo"><a href="<?php echo $siteinfo['domain'];?>"><img src="<?php echo IMG_PATH;?>v9/member_logo.png"/></a></div>
