...
<div class="table-list comment">
	...
	?>
     <tr id="tbody_<?php echo $v['id']?>">
		...
		<td><font color="#888888"><?php echo L('chez')?> <?php echo format::date($v['creat_at'], 1)?> <?php echo L('release')?></font><br /><?php echo $v['content']?> <span style="color:blue;">姓名：</span><?php echo $v['r_name']?> <span style="color:blue;">电话：</span><?php echo $v['tel']?></td>
